...
var TreeTransferComponent = /** @class */ (function () {
    ...
    TreeTransferComponent.prototype.listOnCheck = function (e, checkedKeys) {
        if (e) {
            this.listCheckedKeys = uniq(__spread(this.listCheckedKeys, checkedKeys));
        }
        else {
    ...
    Object.defineProperty(TreeTransferComponent.prototype, "getLeftDisabled", {
        get: function () {
            return difference(this.listData.map(function (item) { return item.key; }), this.treeCheckedKeys).length === 0 &&
                difference(this.treeCheckedKeys, this.listData.map(function (item) { return item.key; })).length === 0;
        },
        enumerable: true,
        configurable: true
    });
